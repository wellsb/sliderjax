...
adaSetup()
readhandle = file(sys.argv[1], 'r')
readcontent = readhandle.readlines()

iter = 0

while True:
    for thisline in readcontent:
        #print count,':',thisline
        iter = iter + 1
        u = thisline.strip().split(',')
        print iter,": FL1:" + u[0] + " FL2:" + u[1] + " FR1:" + u[2] + " FR2:" + u[3] + " BL1:" + u[4] + " BL2:" + u[5] + " BR1:" + u[6] + " BR2:" + u[7]
